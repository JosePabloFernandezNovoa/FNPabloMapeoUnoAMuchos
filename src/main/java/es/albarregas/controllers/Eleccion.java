    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (request.getParameter("op")) {
            ...
            case "deleteModulo":
                ...
                listaCiclos =(List<Ciclo>) (Object) pdao.get("Ciclo");
                request.setAttribute("listado", listaCiclos);
                
                break;
           
        }
        if (request.getParameter("op").equals("add") || (listaCiclos != null && !listaCiclos.isEmpty())) {
            switch (request.getParameter("op")) {
                case "list":
                    url = "JSP/listado.jsp";
                    break;  
